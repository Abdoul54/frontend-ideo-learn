                    ...
                    <CardContent className="p-8" component="form" noValidate autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                {advancedSettings?.user?.remenber_me_enabled && <Controller
                                ...
                                />}
                                {advancedSettings?.user?.allow_password_change &&
                                    <Link
...
*/}
                        {advancedSettings?.register?.registerType !== 'admin' && <p className="mt-8 text-center text-sm text-gray-600">
                            New to our platform?{' '}
                            <Link
                                href="/register"
                                className="font-medium text-primary transition-colors duration-300 hover:text-primary/80"
                            >
                                Create an account
                            </Link>
                        </p>}
